...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'An ActiveRecord-like ORM for Salesforce s_objects'\
                       'for Rails'
  spec.description   = 'Allows for querying and storing of s_objects using'\
                       'a familiar API'
  ...
  spec.add_development_dependency 'overcommit', '~> 0.28'
